...
//   // Save receive amount and update balance
//   const handleReceiveAmount = async () => {
//     if (!selectedClient || !receiveAmount || isNaN(receiveAmount)) {
//       alert("Please select a client and enter a valid receive amount.");
//       return;
//     }
...
//       alert("Receive amount successfully saved and balance updated.");
//       setReceiveAmount("");
//       setReceiveType("cash");
...
//       alert("Failed to update receive amount.");
//     }
//   };
...
//         <div className="mt-6">
//           <h3 className="text-lg font-semibold mb-4">
//             Add Receiving for {selectedClient.billingAddress.name}
//           </h3>
//           <div className="mb-4">
//             <label className="text-sm font-medium">Enter Receive Amount</label>
//             <input
//               type="number"
//               value={receiveAmount}
...
//           <div className="mb-4">
//             <label className="text-sm font-medium">Select Receive Type</label>
//             <select
//               value={receiveType}
