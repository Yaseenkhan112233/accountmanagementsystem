...
//     doc.text(`Client Name: ${invoice.clientName}`, 14, 40);
//     doc.text(`Amount: £${invoice.grandTotal}`, 14, 50);
//     doc.text(`Date: ${invoice.invoiceDate}`, 14, 60);

//     // Add table for items
//     const tableRows = invoice.rows.map((row) => [
//       row.itemName,
//       row.quantity,
//       row.rate.toFixed(2),
...
//                 {/* Using lucide-react icons for Download and Delete */}
//                 <button
